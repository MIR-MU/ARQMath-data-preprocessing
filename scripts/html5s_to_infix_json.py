...
if sys.argv[1] == 'no_problem':
    ...
    ARXMLIV_JSON_INFIX_FILENAME = ARXMLIV_WARNING1_JSON_INFIX_FILENAME
    ARXMLIV_JSON_INFIX_FAILURES_FILENAME = ARXMLIV_WARNING1_JSON_INFIX_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_INFIX_FILENAME = ARXMLIV_WARNING2_JSON_INFIX_FILENAME
    ARXMLIV_JSON_INFIX_FAILURES_FILENAME = ARXMLIV_WARNING2_JSON_INFIX_FAILURES_FILENAME
