...
from .common import ntcir_article_read_html5_worker as read_html5_worker, Text, Math, opt_tokenize as tokenize
from .configuration import POOL_NUM_WORKERS, POOL_CHUNKSIZE, ARXMLIV_NOPROBLEM_HTML5_ZIP_FILENAME, ARXMLIV_NOPROBLEM_JSON_OPT_FILENAME, ARXMLIV_NOPROBLEM_JSON_OPT_FAILURES_FILENAME, ARXMLIV_NOPROBLEM_HTML5_NUM_DOCUMENTS, ARXMLIV_WARNING1_HTML5_ZIP_FILENAME, ARXMLIV_WARNING1_JSON_OPT_FILENAME, ARXMLIV_WARNING1_JSON_OPT_FAILURES_FILENAME, ARXMLIV_WARNING1_HTML5_NUM_DOCUMENTS, ARXMLIV_WARNING2_HTML5_ZIP_FILENAME, ARXMLIV_WARNING2_JSON_OPT_FILENAME, ARXMLIV_WARNING2_JSON_OPT_FAILURES_FILENAME, ARXMLIV_WARNING2_HTML5_NUM_DOCUMENTS
...
if sys.argv[1] == 'no_problem':
    ...
    ARXMLIV_JSON_OPT_FILENAME = ARXMLIV_NOPROBLEM_JSON_OPT_FILENAME
    ARXMLIV_JSON_OPT_FAILURES_FILENAME = ARXMLIV_NOPROBLEM_JSON_OPT_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_OPT_FILENAME = ARXMLIV_WARNING1_JSON_OPT_FILENAME
    ARXMLIV_JSON_OPT_FAILURES_FILENAME = ARXMLIV_WARNING1_JSON_OPT_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_OPT_FILENAME = ARXMLIV_WARNING2_JSON_OPT_FILENAME
    ARXMLIV_JSON_OPT_FAILURES_FILENAME = ARXMLIV_WARNING2_JSON_OPT_FAILURES_FILENAME
