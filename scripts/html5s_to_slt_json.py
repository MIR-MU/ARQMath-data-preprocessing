...
if sys.argv[1] == 'no_problem':
    ...
    ARXMLIV_JSON_SLT_FILENAME = ARXMLIV_WARNING1_JSON_SLT_FILENAME
    ARXMLIV_JSON_SLT_FAILURES_FILENAME = ARXMLIV_WARNING1_JSON_SLT_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_SLT_FILENAME = ARXMLIV_WARNING2_JSON_SLT_FILENAME
    ARXMLIV_JSON_SLT_FAILURES_FILENAME = ARXMLIV_WARNING2_JSON_SLT_FAILURES_FILENAME
