...
from .configuration import POOL_NUM_WORKERS, POOL_CHUNKSIZE, ARXMLIV_NOPROBLEM_XHTML_ZIP_FILENAME, ARXMLIV_NOPROBLEM_JSON_OPT_FILENAME, ARXMLIV_NOPROBLEM_JSON_OPT_FAILURES_FILENAME, ARXMLIV_NOPROBLEM_XHTML_NUM_DOCUMENTS, ARXMLIV_WARNING1_XHTML_ZIP_FILENAME, ARXMLIV_WARNING1_JSON_OPT_FILENAME, ARXMLIV_WARNING1_JSON_OPT_FAILURES_FILENAME, ARXMLIV_WARNING1_XHTML_NUM_DOCUMENTS, ARXMLIV_WARNING2_XHTML_ZIP_FILENAME, ARXMLIV_WARNING2_JSON_OPT_FILENAME, ARXMLIV_WARNING2_JSON_OPT_FAILURES_FILENAME, ARXMLIV_WARNING2_XHTML_NUM_DOCUMENTS
...
if sys.argv[1] == 'no_problem':
    ...
    ARXMLIV_JSON_OPT_FILENAME = ARXMLIV_WARNING_1_JSON_OPT_FILENAME
    ARXMLIV_JSON_OPT_FAILURES_FILENAME = ARXMLIV_WARNING_1_JSON_OPT_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_OPT_FILENAME = ARXMLIV_WARNING_2_JSON_OPT_FILENAME
    ARXMLIV_JSON_OPT_FAILURES_FILENAME = ARXMLIV_WARNING_2_JSON_OPT_FAILURES_FILENAME
