...
from .common import Math, Text, ntcir_topic_read_xhtml as read_xhtml, unicode_to_tree, opt_tokenize as tokenize, simple_preprocess
from .configuration import NTCIR11_MATH2_MAIN_TOPICS_XHTML_FILENAME, NTCIR11_MATH2_MAIN_TOPICS_JSON_OPT_FILENAME, NTCIR11_MATH2_MAIN_TOPICS_XHTML_NUM_TOPICS, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_XHTML_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_OPT_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_XHTML_NUM_TOPICS, XML_NAMESPACES, NTCIR11_MATH2_MAIN_TOPICS_JSON_OPT_FAILURES_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_OPT_FAILURES_FILENAME, POOL_NUM_WORKERS, POOL_CHUNKSIZE, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_OPT_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_OPT_FAILURES_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_XHTML_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_XHTML_NUM_TOPICS
...
if sys.argv[1] == 'ntcir-11-math-2-main':
    ...
    TOPICS_JSON_OPT_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_OPT_FILENAME
    TOPICS_JSON_OPT_FAILURES_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_OPT_FAILURES_FILENAME
