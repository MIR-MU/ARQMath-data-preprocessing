...
from .common import Math, Text, ntcir_topic_read_xhtml as read_xhtml, unicode_to_tree, infix_tokenize as tokenize, simple_preprocess
from .configuration import NTCIR11_MATH2_MAIN_TOPICS_XHTML_FILENAME, NTCIR11_MATH2_MAIN_TOPICS_JSON_INFIX_FILENAME, NTCIR11_MATH2_MAIN_TOPICS_XHTML_NUM_TOPICS, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_XHTML_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_INFIX_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_XHTML_NUM_TOPICS, XML_NAMESPACES, NTCIR11_MATH2_MAIN_TOPICS_JSON_INFIX_FAILURES_FILENAME, NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_INFIX_FAILURES_FILENAME, POOL_NUM_WORKERS, POOL_CHUNKSIZE, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_INFIX_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_INFIX_FAILURES_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_XHTML_FILENAME, NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_XHTML_NUM_TOPICS


assert sys.argv[1] in ('ntcir-11-math-2-main', 'ntcir-12-mathir-arxiv-main', 'ntcir-12-mathir-math-wiki-formula')
if sys.argv[1] == 'ntcir-11-math-2-main':
    ...
    TOPICS_JSON_INFIX_FILENAME = NTCIR11_MATH2_MAIN_TOPICS_JSON_INFIX_FILENAME
    TOPICS_JSON_INFIX_FAILURES_FILENAME = NTCIR11_MATH2_MAIN_TOPICS_JSON_INFIX_FAILURES_FILENAME
    ...
    TOPICS_JSON_INFIX_FILENAME = NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_INFIX_FILENAME
    TOPICS_JSON_INFIX_FAILURES_FILENAME = NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_INFIX_FAILURES_FILENAME
else:
    ...
    TOPICS_JSON_INFIX_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_INFIX_FILENAME
    TOPICS_JSON_INFIX_FAILURES_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_INFIX_FAILURES_FILENAME


def count_xhtml():
    xml_document = etree.parse(TOPICS_XHTML_FILENAME)
    num_topics = len(xml_document.xpath('//ntcir-math:topic | //mathml:topic', namespaces=XML_NAMESPACES))
...
def write_json():
    ...
    num_successful = 0
    num_total = 0
    with open(TOPICS_JSON_INFIX_FILENAME, 'wt') as f, open(TOPICS_JSON_INFIX_FAILURES_FILENAME, 'wt') as failures_f:
        print('{', file=f)
