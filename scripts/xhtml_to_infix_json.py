...
from .configuration import ARXMLIV_XHTML_ZIP_FILENAMES, ARXMLIV_JSON_INFIX_FILENAME, ARXMLIV_JSON_INFIX_FAILURES_FILENAME, POOL_NUM_WORKERS, ARXMLIV_XHTML_NUM_DOCUMENTS, POOL_CHUNKSIZE
