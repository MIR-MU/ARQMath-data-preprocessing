...
if sys.argv[1] == 'ntcir-11-math-2-main':
    ...
    TOPICS_JSON_SLT_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_SLT_FILENAME
    TOPICS_JSON_SLT_FAILURES_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_SLT_FAILURES_FILENAME
