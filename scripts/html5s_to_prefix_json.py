...
if sys.argv[1] == 'no_problem':
    ...
    ARXMLIV_JSON_PREFIX_FILENAME = ARXMLIV_WARNING_1_JSON_PREFIX_FILENAME
    ARXMLIV_JSON_PREFIX_FAILURES_FILENAME = ARXMLIV_WARNING_1_JSON_PREFIX_FAILURES_FILENAME
    ...
    ARXMLIV_JSON_PREFIX_FILENAME = ARXMLIV_WARNING_2_JSON_PREFIX_FILENAME
    ARXMLIV_JSON_PREFIX_FAILURES_FILENAME = ARXMLIV_WARNING_2_JSON_PREFIX_FAILURES_FILENAME
