...
if sys.argv[1] == 'ntcir-11-math-2-main':
    ...
    TOPICS_JSON_PREFIX_FILENAME = NTCIR11_MATH2_MAIN_TOPICS_JSON_PREFIX_FILENAME
    TOPICS_JSON_PREFIX_FAILURES_FILENAME = NTCIR11_MATH2_MAIN_TOPICS_JSON_PREFIX_FAILURES_FILENAME
    ...
    TOPICS_JSON_PREFIX_FILENAME = NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_PREFIX_FILENAME
    TOPICS_JSON_PREFIX_FAILURES_FILENAME = NTCIR12_MATHIR_ARXIV_MAIN_TOPICS_JSON_PREFIX_FAILURES_FILENAME
else:
    ...
    TOPICS_JSON_PREFIX_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_PREFIX_FILENAME
    TOPICS_JSON_PREFIX_FAILURES_FILENAME = NTCIR12_MATHIR_MATHWIKIFORMULA_TOPICS_JSON_PREFIX_FAILURES_FILENAME
...
def write_json():
    ...
    num_successful = 0
    num_total = 0
    with open(TOPICS_JSON_PREFIX_FILENAME, 'wt') as f, open(TOPICS_JSON_PREFIX_FAILURES_FILENAME, 'wt') as failures_f:
        print('{', file=f)
