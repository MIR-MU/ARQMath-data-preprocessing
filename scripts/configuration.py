...
ARQMATH_COLLECTION_POSTS_LATEX_FILENAME = '{}/Posts_V1_0_latex.json.gz'.format(ARQMATH_COLLECTION_OUTPUT_DATA_DIRNAME)
ARQMATH_COLLECTION_POSTS_OPT_FILENAME = '{}/Posts_V1_0_opt.json.gz'.format(ARQMATH_COLLECTION_OUTPUT_DATA_DIRNAME)
ARQMATH_COLLECTION_POSTS_SLT_FILENAME = '{}/Posts_V1_0_slt.json.gz'.format(ARQMATH_COLLECTION_OUTPUT_DATA_DIRNAME)
ARQMATH_COLLECTION_POSTS_PREFIX_FILENAME = '{}/Posts_V1_0_prefix.json.gz'.format(ARQMATH_COLLECTION_OUTPUT_DATA_DIRNAME)
ARQMATH_COLLECTION_POSTS_INFIX_FILENAME = '{}/Posts_V1_0_infix.json.gz'.format(ARQMATH_COLLECTION_OUTPUT_DATA_DIRNAME)
...
ARXMLIV_WARNING1_JSON_OPT_NUM_DOCUMENTS = 498796
