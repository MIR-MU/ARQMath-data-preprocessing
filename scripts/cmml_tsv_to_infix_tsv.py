...
if sys.argv[1] == 'train':
    ...
    ARQMATH_TSV_INFIX_FILENAME = ARQMATH_VALIDATION_TSV_INFIX_FILENAME
    ARQMATH_TSV_INFIX_FAILURES_FILENAME = ARQMATH_VALIDATION_TSV_INFIX_FAILURES_FILENAME
else:
