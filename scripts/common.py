...
from .configuration import POOL_NUM_WORKERS, POOL_CHUNKSIZE, CSV_PARAMETERS, XML_NAMESPACES, ETREE_TOSTRING_PARAMETERS, TSV_OPT_INFIX_OPERATORS
...
def cmml_read_tsv_worker(cmml_row):
    ...
    if len(math_elements) >= 1:
        ...
        math_tokens = resolve_share_elements(str(math_element))
    else:
        math_tokens = ''
