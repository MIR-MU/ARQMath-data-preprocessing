...
if sys.argv[1] == 'train':
    ...
    ARQMATH_TSV_LATEX_FILENAME = ARQMATH_VALIDATION_TSV_LATEX_FILENAME
    ARQMATH_TSV_LATEX_NUM_FORMULAE = ARQMATH_VALIDATION_TSV_LATEX_NUM_FORMULAE
    ARQMATH_TSV_CMML_OUTPUT_FILENAME = ARQMATH_VALIDATION_TSV_CMML_OUTPUT_FILENAME
    ARQMATH_TSV_CMML_OUTPUT_FAILURES_FILENAME = ARQMATH_VALIDATION_TSV_CMML_OUTPUT_FAILURES_FILENAME
    ARQMATH_TSV_PMML_OUTPUT_FILENAME = ARQMATH_VALIDATION_TSV_PMML_OUTPUT_FILENAME
    ARQMATH_TSV_PMML_OUTPUT_FAILURES_FILENAME = ARQMATH_VALIDATION_TSV_PMML_OUTPUT_FAILURES_FILENAME
else:
    ARQMATH_TSV_LATEX_FILENAME = ARQMATH_TEST_TSV_LATEX_FILENAME
    ARQMATH_TSV_LATEX_NUM_FORMULAE = ARQMATH_TEST_TSV_LATEX_NUM_FORMULAE
